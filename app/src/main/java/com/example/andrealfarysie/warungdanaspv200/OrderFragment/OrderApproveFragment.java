...
import com.example.andrealfarysie.warungdanaspv200.Adapter.OrderAdapter;
import com.example.andrealfarysie.warungdanaspv200.Helper.PaginationScrollListener;
 ...
 */
public class OrderApproveFragment extends Fragment {
    ...
    private void loadMore() {
        ...
        mApiService.listOrder2(sharedPrefManager.getSpBranchId(),1,10,offset).enqueue(new Callback<RespListOrder>() {
            @Override
    ...
    private void firstLoad() {
        itShouldLoadMore = false;
        mApiService.listOrder2(sharedPrefManager.getSpBranchId(),1,10,0).enqueue(new Callback<RespListOrder>() {
            @Override
            public void onResponse(Call<RespListOrder> call, Response<RespListOrder> response) {
                if (response.isSuccessful()){
                    itShouldLoadMore = true;
