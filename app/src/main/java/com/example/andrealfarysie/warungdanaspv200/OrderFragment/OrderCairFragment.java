 ...
 */
public class OrderCairFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_order_cair, container, false);
    ...
    private void loadMore() {
        ...
        mApiService.listOrder2(sharedPrefManager.getSpBranchId(),5,10,offset).enqueue(new Callback<RespListOrder>() {
            @Override
    ...
    private void firstLoad() {
        itShouldLoadMore = false;
        mApiService.listOrder2(sharedPrefManager.getSpBranchId(),5,10,0).enqueue(new Callback<RespListOrder>() {
            @Override
            public void onResponse(Call<RespListOrder> call, Response<RespListOrder> response) {
                if (response.isSuccessful()){
                    itShouldLoadMore = true;
